...
Shortkey runs as a menu bar app with no dock icon, staying out of your way until you need it.
...
Trigger Shortkey from any application using a customizable keyboard shortcut.
...
4. Select an action (keyboard or mouse)
         ↓
5. Notification: "Shortkeying your text..."
         ↓

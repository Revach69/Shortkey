...
> For backend development, see [Backend Development](../../shortkey-api/docs/DEVELOPMENT.md)  
...
xcodebuild -scheme Shortkey -configuration Debug
```
...
3. **Notarize**:
   ...
   - Use `notarytool`:
   ```bash
   xcrun notarytool submit Shortkey.app.zip \
...
- [Backend Development](../../shortkey-api/docs/DEVELOPMENT.md) - Backend setup

...
This is the **macOS client** for Shortkey — a menu bar app that lets you transform any selected text using AI, from anywhere on your Mac.

Part of the [Shortkey monorepo](../README.md) — see backend at [`shortkey-api/`](../shortkey-api/).
...
4. Transforms text (AIProviderManager or ShortkeyBackendService)
...
- **ShortkeyBackend/**: Secure backend API communication
  - **ShortkeyBackendService**: Main backend service
...
User presses ⌘⇧S
      ↓
HotKeyManager → ShortkeyController
      ↓
...
User selects action
      ↓
ShortkeyBackendService.transformText()

            ...
            >
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  By downloading, installing, or using Spellify, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our service.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  Subject to your compliance with these Terms, we grant you a limited, non-exclusive, non-transferable, revocable license to use Spellify for your personal or commercial use.
                </p>
                <h3 className="text-xl font-semibold mb-3">You may:</h3>
                <ul className="list-disc pl-6 text-[var(--color-muted)] mb-4 space-y-2">
                  <li>Install Spellify on devices you own or control</li>
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  You agree not to use Spellify to:
                </p>
                <ul className="list-disc pl-6 text-[var(--color-muted)] mb-4 space-y-2">
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  Your use of Spellify is also governed by our Privacy Policy. Please review our{' '}
                  <a
                    href="/privacy"
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  SPELLIFY IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND. WE DO NOT GUARANTEE THAT THE SERVICE WILL BE ERROR-FREE, UNINTERRUPTED, OR MEET YOUR REQUIREMENTS.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  TO THE MAXIMUM EXTENT PERMITTED BY LAW, SPELLIFY SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING OUT OF YOUR USE OF THE SERVICE.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  We reserve the right to suspend or terminate your access to Spellify at any time for violation of these Terms or for any other reason at our discretion.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  We may modify these Terms at any time. We will notify you of material changes via email or through the application. Your continued use of Spellify after changes constitutes acceptance of the new Terms.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  ...
                  <a
                    href="mailto:legal@spellify.app"
                    className="text-[var(--color-primary)] hover:underline"
                  >
                    legal@spellify.app
                  </a>

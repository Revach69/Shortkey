...
const blogPosts = [
  {
    slug: 'introducing-spellify',
    title: 'Introducing Spellify: AI Shortcuts for Your Mac',
    excerpt: 'Learn how Spellify can transform your text workflow with powerful AI shortcuts, right where you work.',
    date: '2024-01-15',
    readTime: '5 min read',
    category: 'Product',
  },
  {
    ...
    title: '10 Productivity Tips Using Spellify',
    excerpt: 'Discover advanced workflows and shortcuts to maximize your productivity with Spellify.',
    date: '2024-01-10',
    readTime: '7 min read',
    category: 'Tips',
  },
      ...
      <main className="pt-32 pb-20">
        <Container size="lg">
          ...
          >
            ...
            >
              Tips, updates, and insights on productivity, AI, and making the most of Spellify.
            </motion.p>
          </motion.div>

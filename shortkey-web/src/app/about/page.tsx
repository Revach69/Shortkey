...
const values = [
  ...
  },
  {
    ...
    description: 'AI should amplify human capability, not replace it. Shortkey puts powerful AI at your fingertips, exactly when you need it.',
  },
  {
    icon: Users,
    ...
    <>
      ...
      <main className="pt-32 pb-20">
        <Container size="lg">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-[var(--color-muted)] mb-4">
                Shortkey was born from a simple frustration: the constant copy-paste dance between work and AI tools.
                As productivity enthusiasts ourselves, we knew there had to be a better way.
              </p>
              <p className="text-[var(--color-muted)] mb-4">
                We built Shortkey to be the AI assistant that lives in your workflow, not outside of it.
              ...
              <p className="text-[var(--color-muted)]">
                Today, thousands of Mac users rely on Shortkey to streamline their writing, translation,
          ...
          >
            <h2 className="text-3xl font-bold mb-4">Join the Shortkey Community</h2>
            <p className="text-lg mb-8 opacity-90">
              Experience the future of text transformation. Download Shortkey today.
            </p>
            <a
              href="/download"

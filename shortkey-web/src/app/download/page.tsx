      ...
      <main className="pt-32 pb-20">
        <Container size="md">
          ...
          >
            ...
            >
              Get started with Shortkey for macOS. Transform your text workflow with AI-powered shortcuts.
            </motion.p>
            ...
            >
              ...
              <ol className="text-left text-sm text-[var(--color-muted)] space-y-2 max-w-xl mx-auto">
                <li>1. Download the Shortkey.dmg file</li>
                <li>2. Open the downloaded file</li>
                <li>3. Drag Shortkey to your Applications folder</li>
                <li>4. Launch Shortkey from Applications</li>

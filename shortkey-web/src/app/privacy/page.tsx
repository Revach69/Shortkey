            ...
            >
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  At Shortkey, we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your information when you use our macOS application and services.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  When you use Shortkey to transform text, we temporarily process your text through our AI services. This text is:
                </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-[var(--color-muted)] mb-4">
                  ...
                  <a
                    href="mailto:privacy@shortkey.app"
                    className="text-[var(--color-primary)] hover:underline"
                  >
                    privacy@shortkey.app
                  </a>
                </p>
              </section>
            </motion.div>

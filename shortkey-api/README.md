# Shortkey Firebase Backend

Simple, secure Firebase backend for Shortkey text transformations.
...
```bash
cd /Users/drorl/Projects/Shortkey
firebase init
...
In `Shortkey/Services/FirebaseBackendManager.swift`, update the Firebase URL:
